...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "crebel " + FormatFullVersion();
...
static const char *strMainNetDNSSeed[][2] = {
    {"crebelion.org","83.215.60.21"},
	 {"crebellcointools.com","82.194.144.170"},
    {NULL, NULL}
};

static const char *strTestNetDNSSeed[][2] = {
    {"crebeltools.com", "testnet-seed.crebeltools.com"},
    {NULL, NULL}
};
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. crebel is probably already running."), addrBind.ToString().c_str());
        else
